...
async def start(client, message):
   if message.chat.type == 'private':
       await Jrbot.send_message(
               chat_id=message.chat.id,
               text="""<b>Hey There, I'm Telegraph Bot

I can upload photos or videos to telegraph. Made by @JenulRanthisa 🇱🇰
...
Hit help button to find out more about how to use me</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                      ...
                                      InlineKeyboardButton(
                                            "Source Code", url="https://github.com/jenul942/Telegraph-uploader-bot")
                                    ]]
                            ),        
...
<b>~ @Infinity_BOTs</b>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        ...
                                        InlineKeyboardButton(
                                            "Source Code", url="hhttps://github.com/jenul942/Telegraph-uploader-bot")
                                    ]]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")
